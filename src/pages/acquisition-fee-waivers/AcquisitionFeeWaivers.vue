<template>
  <main class="bg-acquisitionfeewaivers">
    <div class="w-screen flex flex-col sticky pt-5">
      ...
      <div class="z-1 max-w-245 mx-auto">
        <Box>
          ...
          <h2>
            UX Designer responsible for coordinating between the business team and development team.
          </h2>
        ...
        <Box>
          <h2>
            Because Chrysler Capital and Stellantis are two separate companies, they must
            communicate which vehicles in which regions need a coupon (acquisition fee waiver) to
            stay competitive with other lending companies.
          </h2>
        </Box>
        ...
        <Box>
          ...
          <p>
            8 Regional Brand Managers, who are in charge of understanding the market tendencies in
            their area, will create and excel sheet with 500+ vehicles each month that will get sent
            back and forth with Stellantis.
          </p>
        </Box>
        ...
        <Box>
          ...
          <ul>
            <li>No hierarchy&comma; increasing cognitive load</li>
            <li>Monthly mistakes that persist through attempts to fix the spreadsheet</li>
            <li>Searching for vehicles</li>
            <li>Expansive spreadsheet requiring vertical AND horizontal scrolling</li>
          </ul>

          <h2>What was the goal for the project?</h2>

          <ul>
            <li>Reduce overall time for inputting acquisition fee waivers each month</li>
            <li>Reduce errors from cognitive load and information density</li>
            <li>Streamline error correction for Acquisition Fee Waivers</li>
          </ul>
        </Box>
        ...
        <Box>
          ...
          <p>
            The UX researcher and I interviewed 5 regional brand managers and learned that each
            would go through these steps&colon;
          </p>

          <ol>
            <li>Find the vehicles that had Acquisition Fee Waivers last month</li>
            <li>Mark them to reference as a group later on</li>
            <li>Search for any additional vehicles requiring waivers</li>
            <li>Adjust Acquisition Fees for the selected vehicles while referencing 5 documents</li>
          </ol>
        </Box>

        <Box>
          <h2>Key Features to Consider for Designs</h2>

          <p>Based on these findings&colon;</p>

          <ul>
            <li>Software needs to be able to easily add current waivers to the next month</li>
            <li>
              Users search for vehicles and add them to a group as step one, then adjust acquisition
              fee waivers for the group as step two
            </li>
            <li>
              Personal insight&colon; adding the ability to mass update the waivers could save a lot
              of time
            </li>
          </ul>

          <h2>Considerations Raised By Business SMEs</h2>

          <ul>
            <li>
              Ability to switch regions so that one Regional Brand Manager can take over for another
            </li>
            <li>Some vehicles will have different names but the same identification code</li>
            <li>Reason for waiving acquisition fee</li>
            <li>Reason why acquisition fee waiver was rejected</li>
          </ul>
        </Box>

        <Box>
          <h2>What might the prototype look like?</h2>

          <h3>First off&comma; the approval flow&colon;</h3>
          ...
          <h3>
            ...
            month as well&comma; so I added the ability to quickly select those vehicles and add
            them to the cart.
          </h3>
          ...
          <h3>
            ...
            location&comma; using the same conceptual model as the shopping cart as storefront
            websites
          </h3>
          ...
          <h3>
            By clicking the checkboxes on the left&comma; the mass update feature is activated. A
            user can either remove a group of vehicles from the cart or enter a value on the top row
          ...
          <h3>
            ...
            become highlighted in red. Rejected waivers will be returned to Regional Brand Managers
            to get fixed.
          </h3>
        ...
        <Box>
          <h3>
            With the original prototype done&comma; it was time to see how it worked with the
            Regional Brand Managers
          </h3>

          <h2>Takeaways from Usability Tests</h2>

          <ul>
            <li>System feedback is essential when adding and removing vehicles</li>
            <li>
              Users would like to be able to download an excel file once acquisition fee waivers
              have been approved
            </li>
            <li>
          ...
          <ul>
            <li>
              Clicking the checkbox and clicking Add to Cart takes two steps when only one is needed
            </li>
            <li>System Feedback message style deviates from the currently implemented design</li>
            <li>Notes icon deviates from the current system</li>
          </ul>
        </Box>

        <Box>
          <h2>Key Changes in the Final Prototype</h2>
          ...
          <h3>
            The &quot;Search&quot; and &quot;Vehicle Cart&quot; toggle have been combined to show
            their relationship. The toggle lives in a bar that stays on the bottom of the screen on
            scroll.
          </h3>
          ...
          <h3>
            Clicking the checkbox next to a vehicle or above a vehicle model will automatically add
          ...
          <h3>
            When a manager rejects vehicles elected for acquisition fee waivers&comma; they get
            returned to the Regional Brand Manager for revision. Those rejected vehicles are
            collected in a list at the top to avoid requireing searching through hundreds of rows of
            vehicles.
          </h3>
        ...
        <Box>
          ...
          <ol>
            ...
            <li>
              Future development may also add more of the functionality of the current spreadsheet
              tool such as showing volume and the Residual Balancing Calculation
            </li>
          </ol>
        </Box>
...
store.setBackgroundColor('acquisitionfeewaivers')
</script>
