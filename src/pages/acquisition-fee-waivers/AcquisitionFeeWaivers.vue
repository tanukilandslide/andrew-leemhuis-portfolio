  ...
  <div :class="'w-screen bg-' + store.backgroundColor">
    <main class="max-w-245">
      ...
      <Box>
        ...
        <p>
          The UX researcher and I interviewed 5 regional brand managers and learned that each would
          go through these steps&colon;
        </p>
      ...
      <Box>
        ...
        <h3>
          ...
          month as well&comma; so I added the ability to quickly select those vehicles and add them
          to the cart.
        </h3>
      ...
      <Box>
        <h3>
          With the original prototype done&comma; it was time to see how it worked with the Regional
          Brand Managers
        </h3>
      ...
      <Box>
        ...
        <h3>
          ...
          returned to the Regional Brand Manager for revision. Those rejected vehicles are collected
