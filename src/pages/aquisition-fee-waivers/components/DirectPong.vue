<template>
  <svg id="pong-board" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 980 687.46">
    <title>Excel Pong</title>
    <desc>
      A Pong-like game screen with Stellantis's paddle on the left side and Chrysler Capital's
      paddle on the other with an excel document being passed between the two. The versions of both
      files vary, showing an inconsistency in data between them.
    </desc>
    <g id="pong">
      <g id="center-line">
        ...
        <path
          class="cls-2"
          d="m498.5,653.2h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Zm0-45.85h-17.01v-22.92h17.01v22.92Z"
        />
      ...
      <g id="excel-file">
        <path
          class="cls-3"
          d="m352.91,246.47h38.65l18.52,18.52v58.22c0,.97-.79,1.76-1.76,1.76h-55.42c-.97,0-1.76-.79-1.76-1.76v-74.98c0-.97.79-1.76,1.76-1.76Z"
        />
      ...
      <g id="ccap-paddle">
        ...
        <g id="ccap-logo">
          <path
            ...
            data-name="Fill 1"
            class="cls-2"
            d="m898.52,393.47h19.81v-2.25h-13.76v-9.81s-6.06,0-6.06,0v12.06Z"
          />
          <path
            id="Fill_2"
            data-name="Fill 2"
            class="cls-2"
            d="m806.16,381.41v12.06h6.06v-4.92h10.53v4.92h6.06v-12.06h-6.06v4.91h-10.53v-4.91h-6.06Z"
          />
          <g id="Group_26" data-name="Group 26">
            <path
              ...
              data-name="Fill 3"
              class="cls-2"
              d="m870.45,381.41l-5.64,5.09-5.84-5.09h-7.04s8.54,7.11,8.6,7.15v4.91h6.06v-5.02s7.96-7.04,7.96-7.04h-4.1Z"
            />
            <path
              id="Fill_5"
              data-name="Fill 5"
              class="cls-2"
              d="m920.54,393.47h20.21v-2.03h-14.15v-3.08h13.61v-2.02h-13.61v-2.9h13.88v-2.03s-19.95,0-19.95,0v12.06Z"
            />
            <path
              id="Fill_7"
              data-name="Fill 7"
              class="cls-2"
              d="m874.75,384.55c0,2.79,3.23,3.46,7.63,4,4.48.56,6.57.71,6.57,1.76,0,.94-1.33,1.44-5.19,1.44-2.9-.02-5.79-.43-8.59-1.22-.03.12-.57,2.52-.57,2.52,3.09.66,6.24.97,9.4.94,5.84,0,11.48-1.02,11.48-4.18,0-2.17-2.29-3.29-8.8-4.04-2.7-.32-5.53-.51-5.53-1.56,0-.77.78-1.13,4.63-1.13,2.54.02,5.06.33,7.52.93l.49-2.33c-3.13-.54-6.3-.81-9.47-.81-4.15,0-9.57.57-9.57,3.67"
            />
            <path
              id="Fill_9"
              data-name="Fill 9"
              class="cls-2"
              d="m782.68,387.44c0,3.9,4.11,6.55,12.62,6.55,2.46-.03,4.91-.22,7.35-.56l.53-2.52c-2.19.3-4.39.47-6.6.5-4.73,0-7.91-1.14-7.91-3.97s3.03-3.97,8-3.97c2.18.02,4.36.19,6.52.51l-.53-2.54c-2.37-.33-4.77-.51-7.16-.55-8.64,0-12.8,2.56-12.8,6.54"
            />
            <path
              id="Fill_11"
              data-name="Fill 11"
              class="cls-2"
              d="m831.64,393.47h6.06v-9.92c.83-.05,1.76-.15,3.18-.15,1.14-.03,2.28.03,3.41.15,1.85.29,2.45.88,2.43,1.67-.01.82-.82,1.57-2.69,1.84-1.04.14-2.08.21-3.13.19-.63,0-1.1,0-1.84-.04l6.89,6.26h7.71l-6.98-5.02c1.11-.03,2.2-.23,3.25-.6,1.85-.6,2.76-1.56,2.76-2.63.02-1.4-.89-2.62-4.28-3.38-1.88-.43-4.26-.61-7.47-.62-4.35,0-8.85.17-9.29.19v12.06Z"
            />
      ...
      <g id="v1">
        <polygon
          id="letter-v-1"
          class="cls-2"
          points="300.49 30.66 284.28 30.66 284.28 81.48 273.28 81.48 273.28 94.94 263.28 94.94 263.28 101.35 254.88 101.35 254.88 94.94 244.88 94.94 244.88 81.48 234.88 81.48 234.88 30.66 218.66 30.66 218.66 84.52 228.66 84.52 228.66 94.94 238.66 94.94 238.66 108.41 250.66 108.41 250.66 117.56 266.88 117.56 266.88 108.41 279.49 108.41 279.49 94.94 289.49 94.94 289.49 84.52 300.49 84.52 300.49 30.66"
        />
        <polygon
          id="num-1"
          class="cls-2"
          points="372.25 104.1 372.25 30.66 356.04 30.66 356.04 37.76 344.7 37.76 344.7 51.23 356.04 51.23 356.04 104.1 344.7 104.1 344.7 117.56 356.04 117.56 372.25 117.56 383.59 117.56 383.59 104.1 372.25 104.1"
        />
      </g>
      <g id="v3">
        <polygon
          id="num-3"
          class="cls-2"
          points="754.97 30.66 700.34 30.66 700.34 46.88 754.97 46.88 754.97 66 700.34 66 700.34 82.22 754.97 82.22 754.97 101.35 700.34 101.35 700.34 117.56 754.97 117.56 771.18 117.56 771.18 101.35 771.18 82.22 771.18 66 771.18 46.88 771.18 30.66 754.97 30.66"
        />
        <polygon
          id="letter-v-2"
          class="cls-2"
          points="665.11 30.66 648.9 30.66 648.9 81.48 637.9 81.48 637.9 94.94 627.9 94.94 627.9 101.35 619.5 101.35 619.5 94.94 609.5 94.94 609.5 81.48 599.5 81.48 599.5 30.66 583.28 30.66 583.28 84.52 593.28 84.52 593.28 94.94 603.28 94.94 603.28 108.41 615.28 108.41 615.28 117.56 631.5 117.56 631.5 108.41 644.11 108.41 644.11 94.94 654.11 94.94 654.11 84.52 665.11 84.52 665.11 30.66"
        />
      </g>
    </g>
  </svg>
...
#stellantis-paddle {
  animation: left-paddle-move 2s linear infinite alternate;
}

#ccap-paddle {
  animation: right-paddle-move 2s linear infinite alternate;
}

#excel-file {
  animation: ball-move 4s linear infinite alternate;
}

@keyframes left-paddle-move {
  0% {
