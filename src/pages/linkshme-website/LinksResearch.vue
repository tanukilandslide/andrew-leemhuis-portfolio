<template>
  ...
  <Box>
    ...
    <p>
      Once the key themes were determined, I was able to create 3 distinct personas. These personas
      were the main parties who would ultimately determine what software would manage their
      shipments to customers, billing of customer insurance, and inventory.
    </p>
  </Box>
  ...
  <Box>
    ...
    <p>
      Software needs to be cost-effective and compliant with applicable laws. It must also be viable
